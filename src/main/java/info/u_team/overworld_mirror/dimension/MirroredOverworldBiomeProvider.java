...
public class MirroredOverworldBiomeProvider extends OverworldBiomeProvider {
	...
	public MirroredOverworldBiomeProvider(OverworldBiomeProviderSettings settingsProvider) {
		super(settingsProvider);
		final WorldInfo worldinfo = settingsProvider.getWorldInfo();
		final OverworldGenSettings overworldgensettings = settingsProvider.getGeneratorSettings();
		final CommonConfig config = CommonConfig.getInstance();
		final GenLayer[] agenlayer = LayerUtil.buildOverworldProcedure(config.seedType.get().calculateSeed(config.seedValue.get(), worldinfo.getSeed()), worldinfo.getGenerator(), overworldgensettings);
